...
public class JwtService {
    ...
    // 256-bit secure base64 encoded key for HMAC-SHA256 signing
    @Value("${application.security.jwt.secret-key:ZW5vdWdoLXNlY3JldC1rZXktZm9yLWFwLWphbmEtc2V2YS1hcHBsaWNhdGlvbi1iYWNrZW5kLXNlY3VyaXR5LTI1Ni1iaXQ=}")
